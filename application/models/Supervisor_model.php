<?php
 ...
 class Supervisor_model extends CI_Model{
 	...
 	function fetch_drinks_in_stock(){
 		$this->db->select('products.PRODUCT_NAME, stock.QUANTITY, stock.ADDED_STOCK, stock.ADDED_STOCK, products.COST_PRICE, products.SALES_PRICE, stock.QUANTITY_SOLD, staff.NAME');
 		$this->db->from('stock');
