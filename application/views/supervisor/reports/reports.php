                                                    ...
                                                    <div class="modal-body">
                                                       <form method="post" action="<?php echo base_url(); ?>supervisor/sales_sheet" target="_blank">
                                                            ...
                                                            <div class="form-group">
                                                             ...
                                                             <input type="text"  class="form-control" required="" value="<?php echo date('F d, Y'); ?>" disabled>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                       <form method="post" action="<?php echo base_url(); ?>supervisor/sales_reports_day" target="_blank">
                                                           <div class="form-group">
                                                                <input type="text"  class="form-control" required="" disabled="" value="<?php echo date('F d, Y'); ?>">
                                                             <input type="hidden" name="date"  class="form-control" required="" value="<?php echo date('Y-m-d'); ?>">
                                                           </div>
